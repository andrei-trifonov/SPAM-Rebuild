...
public class NewGameCore : MonoBehaviour
{
    ...
    private void LoadSaveData(string savenum)
    {
        ...
        LoadMusic(loadedData);
        LoadActors(loadedData);
    ...
    private void LoadMusic(SaveObject loadedData)
    {
        Item item = new Item();
    ...
    private void LoadActors(SaveObject loadedData)
    {
        Item item = new Item();
    ...
    private void LoadScene(SaveObject loadedData)
    {
        Item item = new Item();
    ...
    private void LoadText(SaveObject loadedData)
    {
        Item item = new Item();
